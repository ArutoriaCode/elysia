import{B as k,p as y,f as h,i as C}from"./module-ant-design-vue-1412c860.js";import{av as V,ak as w,aw as g,as as B}from"./vendor-77887a9f.js";import{c as N}from"./complete-dfa031d6.js";import{u as j}from"./useDefineModel-3ab56a64.js";import{k as E,aJ as O,_ as D,bm as a,f as o,u as e,D as r,E as J,a1 as p}from"./module-@vue-bde5bc49.js";import"./index-cc5c85ee.js";const M=p("div",null,[r(" 可以使用 "),p("span",{style:{"font-weight":"bold"}},"ctx"),r(" 来获取组件实例上下文 ")],-1),A={__name:"select-options-editor",setup(T){const d=[V(),N,w()],{modelValue:l,propertyCN:i,property:u,action:c}=j(),s=E(!1),m=()=>{s.value=!0},_=`
  合法的JSON
  [{"label":"标签","value":"值"}]
